...
public class RadiatorStateOnProcessorTest {
    ...
    void testCase1() {
        List<Report> reports = List.of(
                ...
                new Report(3L, true, false, LocalTime.of(3, 0)),
                new Report(4L, false, false, LocalTime.of(4, 0)),
                new Report(5L, true, false, LocalTime.of(5, 0)),
    ...
    void testCase2() {
        List<Report> reports = List.of(
                new Report(1L, true, false, LocalTime.of(1, 0)),
                new Report(2L, false, false, LocalTime.of(2, 0)),
                new Report(3L, true, false, LocalTime.of(3, 0)),
                new Report(4L, false, false, LocalTime.of(4, 0)),
                new Report(5L, true, false, LocalTime.of(5, 0)),
    ...
    void testCase3() {
        List<Report> reports = List.of(
                ...
                new Report(2L, false, false, LocalTime.of(2, 0)),
                new Report(3L, true, false, LocalTime.of(3, 0)),
                new Report(4L, true, false, LocalTime.of(4, 0)),
                new Report(5L, false, false, LocalTime.of(5, 0)),
                new Report(6L, true, false, LocalTime.of(6, 0))
        );
    ...
    void testCase5() {
        List<Report> reports = List.of(
                ...
                new Report(4L, false, false, LocalTime.of(4, 0)),
                new Report(5L, false, false, LocalTime.of(5, 0)),
                new Report(6L, true, false, LocalTime.of(7, 0))
        );
    ...
    void testCase6() {
        List<Report> reports = List.of(
                new Report(1L, true, false, LocalTime.of(1, 0)),
                new Report(2L, true, false, LocalTime.of(2, 0)),
                new Report(3L, true, false, LocalTime.of(3, 0)),
                new Report(4L, false, false, LocalTime.of(4, 0)),
                new Report(5L, true, false, LocalTime.of(5, 0)),
                new Report(6L, true, false, LocalTime.of(6, 0))
